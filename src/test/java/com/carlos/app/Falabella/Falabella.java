...
public class Falabella {
	...
	WebDriver driver;
	int opcion_1ToInteger = 0, opcion_2ToInteger = 0, opcion_3ToInteger = 0, opcion_4ToInteger = 0,
			opcion_5ToInteger = 0, opcion_6ToInteger = 0, opcion_7ToInteger = 0;
	int menor = 0, a = 0, one=0;
	int array[] = new int[7];
	...
	public void Automatizar() throws InterruptedException {
		...
		Boolean explicit;
		explicit = wait.until(
				ExpectedConditions.invisibilityOfElementLocated(By.xpath("//*[@id='table']/tbody/tr[1]/td[1]/span/i")));
		if (explicit == true) {
			System.out.print("Primera Opcion: $");
			WebDriverWait wait_2 = new WebDriverWait(driver, 5);
			boolean basic_1 = driver.findElement(By.xpath("//div[@id='cotizaciones']//tr[1]//td[1]//span[1]"))
					.isDisplayed();
			if (basic_1 == false) {
				String opcion_1 = driver.findElement(By.xpath(
						"//body[@id='app']/div[@id='cotizaciones']/div[@class='page']/div[@class='container']/div[@class='sixteen columns']/table[@id='table']/tbody/tr[1]/td[1]/div[1]"))
						.getAttribute("prima");
		...
		Boolean explicit_2;
		explicit_2 = wait.until(
				ExpectedConditions.invisibilityOfElementLocated(By.xpath("//*[@id='table']/tbody/tr[2]/td[1]/span/i")));
		if (explicit_2 == true) {
			System.out.print("Segunda Opcion: $");
			WebDriverWait wait_2 = new WebDriverWait(driver, 5);
			boolean basic_2 = driver.findElement(By.xpath("//div[@id='cotizaciones']//tr[2]//td[1]//span[1]"))
					.isDisplayed();
			if (basic_2 == false) {
				String opcion_2 = driver.findElement(By.xpath(
						"//body[@id='app']/div[@id='cotizaciones']/div[@class='page']/div[@class='container']/div[@class='sixteen columns']/table[@id='table']/tbody/tr[2]/td[1]/div[1]"))
						.getAttribute("prima");
		...
		Boolean explicit_3;
		explicit_3 = wait.until(
				ExpectedConditions.invisibilityOfElementLocated(By.xpath("//*[@id='table']/tbody/tr[3]/td[1]/span/i")));
		if (explicit_3 == true) {
			System.out.print("Tercera Opcion: $");
			WebDriverWait wait_2 = new WebDriverWait(driver, 5);
			boolean basic_3 = driver.findElement(By.xpath("//div[@id='cotizaciones']//tr[3]//td[1]//span[1]"))
					.isDisplayed();
			if (basic_3 == false) {
				String opcion_3 = driver.findElement(By.xpath(
						"//body[@id='app']/div[@id='cotizaciones']/div[@class='page']/div[@class='container']/div[@class='sixteen columns']/table[@id='table']/tbody/tr[3]/td[1]/div[1]"))
						.getAttribute("prima");
		...
		Boolean explicit_4;
		explicit_4 = wait.until(
				ExpectedConditions.invisibilityOfElementLocated(By.xpath("//*[@id='table']/tbody/tr[4]/td[1]/span/i")));
		if (explicit_4 == true) {
			System.out.print("Cuarta Opcion: $");
			WebDriverWait wait_2 = new WebDriverWait(driver, 5);
			boolean basic_4 = driver.findElement(By.xpath("//div[@id='cotizaciones']//tr[4]//td[1]//span[1]"))
					.isDisplayed();
			if (basic_4 == false) {
				String opcion_4 = driver.findElement(By.xpath(
						"//body[@id='app']/div[@id='cotizaciones']/div[@class='page']/div[@class='container']/div[@class='sixteen columns']/table[@id='table']/tbody/tr[4]/td[1]/div[1]"))
						.getAttribute("prima");
		...
		Boolean explicit_5;
		explicit_5 = wait.until(
				ExpectedConditions.invisibilityOfElementLocated(By.xpath("//*[@id='table']/tbody/tr[5]/td[1]/span/i")));
		if (explicit_5 == true) {
			System.out.print("Quinta Opcion: $");
			WebDriverWait wait_2 = new WebDriverWait(driver, 5);
			boolean basic_5 = driver.findElement(By.xpath("//div[@id='cotizaciones']//tr[5]//td[1]//span[1]"))
					.isDisplayed();
			if (basic_5 == false) {
				String opcion_5 = driver.findElement(By.xpath(
						"//body[@id='app']/div[@id='cotizaciones']/div[@class='page']/div[@class='container']/div[@class='sixteen columns']/table[@id='table']/tbody/tr[5]/td[1]/div[1]"))
						.getAttribute("prima");
		...
		Boolean explicit_6;
		explicit_6 = wait.until(
				ExpectedConditions.invisibilityOfElementLocated(By.xpath("//*[@id='table']/tbody/tr[6]/td[1]/span/i")));
		if (explicit_6 == true) {
			System.out.print("Sexta Opcion: $");
			WebDriverWait wait_2 = new WebDriverWait(driver, 5);
			boolean basic_6 = driver.findElement(By.xpath("//div[@id='cotizaciones']//tr[6]//td[1]//span[1]"))
					.isDisplayed();
			if (basic_6 == false) {
				String opcion_6 = driver.findElement(By.xpath(
						"//body[@id='app']/div[@id='cotizaciones']/div[@class='page']/div[@class='container']/div[@class='sixteen columns']/table[@id='table']/tbody/tr[6]/td[1]/div[1]"))
						.getAttribute("prima");
		...
		Boolean explicit_7;
		explicit_7 = wait.until(
				ExpectedConditions.invisibilityOfElementLocated(By.xpath("//*[@id='table']/tbody/tr[6]/td[1]/span/i")));
		if (explicit_7 == true) {
			System.out.print("Septima Opcion: $");
			WebDriverWait wait_2 = new WebDriverWait(driver, 5);
			boolean basic_7 = driver.findElement(By.xpath("//div[@id='cotizaciones']//tr[6]//td[1]//span[1]"))
					.isDisplayed();
			if (basic_7 == false) {
				String opcion_7 = driver.findElement(By.xpath(
						"//body[@id='app']/div[@id='cotizaciones']/div[@class='page']/div[@class='container']/div[@class='sixteen columns']/table[@id='table']/tbody/tr[6]/td[1]/div[1]"))
						.getAttribute("prima");
